...
namespace Shadowsocks.Controller
{
    public static class I18N
    {
        ...
        public static string GetString(string key, params object[] args)
        {
            ...
            if (!_strings.TryGetValue(trimmedKey, out var value) || string.IsNullOrEmpty(value))
            {
                value = Strings.ResourceManager.GetString(trimmedKey, CultureInfo.CurrentUICulture);
            }
